...
class OrderAdmin extends Okay {
    ...
    public function fetch() {
        ...
        if($this->request->method('post')) {
            ...
            $order->retail_id = $this->request->post('retail_id', 'string');
    ...
    /**
     * Метод отправки данных о заказе в RetailCRM
     * @param $order
     */
    function sendToCrm($order) {
        if ($order->retail_id != '' && $this->retail->request('ordersGet', $order->retail_id, 'id') == true) {
